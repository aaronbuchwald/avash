...
cmds = {
    ...
    "startnode " .. nodeprefix .. "2 --db-enabled=false --api-ipcs-enabled=false --http-port=5001 --staking-port=9151 --log-level=verbo --bootstrap-ips=127.0.0.1:9150 --bootstrap-ids=7Xhw2mDxuDS44j42TCB6U5579esbSt3Lg --staking-tls-cert-file=certs/keys2/staker.crt --staking-tls-key-file=certs/keys2/staker.key",
