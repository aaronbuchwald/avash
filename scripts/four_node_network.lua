cmds = {
    ...
    "startnode apinode --db-enabled=false --api-ipcs-enabled=true --http-port=9850 --staking-port=9158 --xput-server-port=9258 --log-level=verbo --bootstrap-ips=127.0.0.1:9155,127.0.0.1:9156,127.0.0.1:9157",
}
